...
public class Main {
    ...
    public static final String DUP_PHONES    = "There are contacts that share phone numbers.";
    public static final String ALL_DIFF_PHONES = "All contacts have different phone numbers.";
    ...
    private static void existsEqualPhoneNumbers(ContactBook cBook) {
        boolean dup = cBook.hasDuplicatedPhones();
        System.out.println(dup ? DUP_PHONES : ALL_DIFF_PHONES);
    }
